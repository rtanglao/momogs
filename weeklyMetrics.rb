...
`./getactive.rb #{start_date_str} #{end_date_str} 2>#{stderrfile} 1>#{stdoutfile}`
stderrfile = 'gethappy.' + start_date + '.' + end_date + '.stderr'
stdoutfile = 'gethappy.' + start_date + '.' + end_date + '.stdout'
`./gethappykludged.rb #{start_date_str} #{end_date_str} 2>#{stderrfile} 1>#{stdoutfile}`
stderrfile = 'getresolved' + start_date + '.' + end_date + '.stderr'
stdoutfile = 'getresolved.' + start_date + '.' + end_date + '.stdout'
`./getNumCreatedNumResolved.rb #{start_date_str} #{end_date_str} 2>#{stderrfile} 1>#{stdoutfile}`
